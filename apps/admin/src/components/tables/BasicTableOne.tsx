...
function roleKey(role: string) {
  switch (role) {
    case "Web Designer": return "WebDesigner";
    case "Project Manager": return "ProjectManager";
    case "Content Writing": return "ContentWriting";
    case "Digital Marketer": return "DigitalMarketer";
    case "Front-end Developer": return "FrontEndDeveloper";
    default: return role;
  }
}
function projectKey(name: string) {
  switch (name) {
    case "Agency Website": return "AgencyWebsite";
    case "Technology": return "Technology";
    case "Blog Writing": return "BlogWriting";
